...
const { ctrl_Orders_get, ctrl_Orders_status } = require('../controllers/ctrl_order');
...
router.post('/get_orders', ctrl_Orders_get);
router.post('/update_order_status', ctrl_Orders_status);
